...
# It will run the current directory's buyer_enabled.py and seller_enabled.py files
...
# Check if current buyer_enabled.py and seller_enabled.py exist
BUYER_FILE="$(pwd)/buyer_enabled.py"
SELLER_FILE="$(pwd)/seller_enabled.py"
